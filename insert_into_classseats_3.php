<!DOCTYPE html>
<html>
<body style="background-image: url(adminlogin.jpeg); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
...
// Initialize ns to prevent undefined variable notice
if (!isset($_SESSION["ns"])) {
    $_SESSION["ns"] = 0; // Default value
}
...
if (isset($_POST["tno"])) {
    ...
    // Assigning stations to session variables
